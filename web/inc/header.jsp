                                        ...
                                        <li class="header__navbar-item header__navbar-item--separa">
                                            ...
                                            <div class="header__navbar-profile">
                                                <ul class="header__navbar-profile-list">
                                                    <li class="header__navbar-profile-item header__navbar-item--notify">
                                                        <a href="#" class="header__navbar-profile-link">Profile</a>
                                                    </li>
                                                    <li class="header__navbar-profile-item">
                                                        <a href="LogoutServlet" class="header__navbar-profile-link">Logout</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                    ...
                    <div class="container">
                        <div class="header__with-search">
                            ...
                            <div class="header__search-cart">
                                ...
                                <div class="header__search-heart">
                                    <a href="CartServlet" class="header__search-heart-link">
